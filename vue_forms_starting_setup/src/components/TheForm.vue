<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      ...
      <div>
        <input id="how-video" name="how" type="radio" value="vedio" v-model="how" />
    ...
    <div class="form-control">
      <input type="checkbox" id="confirm-checkbox" name="confirm-terms" v-model="confirm">
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      this.username = ''
      console.log('Users Age ' + this.userage)
      this.userage = null
      ...
      this.how = null
      console.log('Confirm Values ' + this.confirm)
      this.confirm = false
    },
    validateInput() {
      if (this.username === '') {
